...
import profile from '../Assets/self1.jpg'
            ...
            <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+91 8400194270</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">guptasrajan47@gmail.com</span>
                    </p>
                </div>
                ...
                <div class="mt-6 w-80 md:mt-8">
                    ...
                    <div class="flex mt-4 -mx-1.5 ">
                        ...
                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/in/srajan-gupta-369aa9235/">
                        ...
                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.instagram.com/thesrajangupta/?igsh=MTA4eXBtbjIwcXlpcQ%3D%3D">
